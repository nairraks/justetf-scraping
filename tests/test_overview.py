...
class TestGetRawOverview:
    ...
    def test_returns_list_of_dicts(self, mock_session_cls, mock_html_response):
        ...
        result = get_raw_overview(strategy="epg-longOnly")
    ...
    def test_deduplicates_across_strategies(self, mock_session_cls, mock_html_response):
        ...
        result = get_raw_overview(strategy=None)  # Requests all strategies
...
class TestLoadOverview:
    @patch("justetf_scraping.overview.get_raw_overview")
